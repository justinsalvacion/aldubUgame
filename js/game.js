...
window.LEVEL_CONFIG = [
		...
		// d - almost perfect!
	{
		...
		key:{ x:20, y:120},
		circles: [
			{x:75,y:-5,radius:57.5},
			{x:75,y:100,radius:42}
		],
		countdown:100
	},
	...
	// HEART 
	{
		...
		circles: [
			{x:50,y:50,radius:25},
			{x:100,y:50,radius:25},
			{x:37.5,y:50,radius:5,invisible:true},
			{x:0,y:150,radius:72.5},
			{x:150,y:150,radius:72.5}
		],
